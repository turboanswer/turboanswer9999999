...
- `server/paypal.ts` — plan names, descriptions, price checks (e.g. `=== 10`), Enterprise desc.
...
Current map (June 2026): Turbo=free $0 Claude Haiku 5.5 · Turbo Pro=$10/mo Claude Sonnet 4.6 · Matrix AI=research $35/mo Claude Opus 4.8 · Enterprise=$100/mo 5-seat team SKU of Matrix AI.
