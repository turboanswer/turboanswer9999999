...
<div style="background-color:#000000;padding:32px;border:1px solid #333;border-top:none;border-radius:0 0 12px 12px;">
  ...
  <hr style="border:none;border-top:1px solid #333;margin:24px 0;">
  <p style="font-size:12px;color:#777;margin:0;">TurboAnswer · support@turboanswer.it.com · turboanswer.it.com/support</p>
</div>
</body>
</html>`;
  try {
