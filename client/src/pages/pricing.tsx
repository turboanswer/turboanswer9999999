...
const plans: PricingPlan[] = [
  ...
  },
  {
    ...
    price: '$30',
    period: 'per month',
    description: 'Multi-brand verification: Claude + GPT-4o + Gemini Pro',
    features: [
      '🔬 Matrix AI Panel — Claude Sonnet 4.5 + GPT-4o + Gemini 2.5 Pro all answer in parallel, judged by Claude',
  ...
  },
  {
    ...
    features: [
      ...
      '🔬 Same Matrix AI Panel: Claude + GPT-4o + Gemini Pro',
      '🎬 AI Video Studio (Google Veo 3.1)',
