      ...
      <section className="relative overflow-hidden" style={{ minHeight: "80vh" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-24 pb-16 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-500/20 mb-8" style={{ background: "rgba(59,130,246,0.08)" }}>
            ...
            <span className="text-sm text-blue-300 font-medium">Now powered by GPT-4o mini — free for everyone</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Free tier runs on <span className="text-white font-semibold">GPT-4o mini</span>. Upgrade to Turbo AI Pro for <span className="text-white font-semibold">GPT-4.1</span>, image generation, and 4× longer answers.<br />
          ...
          {[
            {
              ...
              title: "AI Chat",
              desc: "Free runs on GPT-4o mini. Turbo AI Pro upgrades to GPT-4.1 with 4× longer answers and image generation. Matrix AI runs GPT-5.4 + GPT-4.1 in parallel and judges the best answer.",
              href: "/chat",
            ...
            },
            {
              ...
              desc: "Paste an error + your GitHub repo. GPT-5.1 Codex finds the bug and opens a real PR with the fix.",
              href: "/stack-trace-surgeon",
              gradient: "linear-gradient(135deg, #1a0a2e, #2a0d3e)",
              iconBg: "rgba(168,85,247,0.15)",
              iconColor: "#c084fc",
              badge: isResearch || isEnterprise ? "Included" : "Matrix AI",
            },
            {
            ...
            <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-gray-400 mb-6 max-w-lg">
                  5 team members. Matrix AI. Deep research reports. Everything your team needs — one subscription.
                </p>
