        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section className="bg-blue-950 border border-blue-700 p-5 rounded-lg">
            ...
            <p className="text-blue-100">
              We do not knowingly collect personal information from children under 13. Any account we discover to belong to a user under 13 will be <strong>terminated immediately and all associated data deleted</strong>. Parents may request account deletion at any time by emailing <a href="mailto:support@turboanswer.it.com" className="text-blue-300 underline">support@turboanswer.it.com</a> or calling <a href="tel:+18663206042" className="text-blue-300 underline">(866) 320-6042</a>.
            </p>
          </section>
