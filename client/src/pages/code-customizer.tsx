      ...
      <div className="max-w-5xl mx-auto px-5 py-8">
        ...
        <Card className="p-6 mb-6" style={{ background: cardBg, borderColor: border }}>
          <div className="space-y-4">
            ...
            >
              {loading ? (
                <><Loader2 className="h-4 w-4 mr-2 animate-spin" /> Customizing with GPT-4.1…</>
              ) : (
        ...
        <div className="mt-10 pt-6 border-t text-center text-[11px]" style={{ borderColor: border, color: subtext }}>
          Code Customizer by TurboAnswer · Powered by GPT-4.1 · Reads only the file you point at · Tokens never stored
        </div>
      </div>
    </div>
  );
