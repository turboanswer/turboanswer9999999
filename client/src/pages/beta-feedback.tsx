        ...
        <Card className="bg-gradient-to-br from-emerald-950/40 to-zinc-950 border-emerald-900/40 mb-6">
          <CardContent className="p-4">
            ...
            <div className="grid sm:grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex items-start gap-2"><Headphones className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" /><span className="text-zinc-300"><b>Priority support</b> — email & support tickets with fast replies, any time.</span></div>
